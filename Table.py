...
from PiecesCode.Rook import Rook
from PiecesCode.Bishop import Bishop
from PiecesCode.Knight import Knight
from PiecesCode.Queen import Queen
from PiecesCode.King import King
from PiecesCode.Pawn import Pawn
class Board:
